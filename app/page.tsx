...
const mealPlans: MealPlan[] = [
  ...
  },
  {
    ...
    rows: [
      { meal: "Southern Baked Chicken/ Potato Wedges", date: "14/09/26", totalKey: "sept-plan2-southern-baked-chicken" },
      { meal: "Salmon Fish Cake", date: "15/09/26", totalKey: "sept-plan2-salmon-fish-cake" },
      { meal: "Chicken and Leek Pie", date: "16/09/26", totalKey: "sept-plan2-chicken-leek-pie" },
      { meal: "Beef Burrito", date: "17/09/26", totalKey: "sept-plan2-beef-burrito" },
      { meal: "Breaded Fish with Potato Waffles", date: "18/09/26", totalKey: "sept-plan2-fish-waffles" },
    ],
  },
  {
    title: "September Meal Plan 3",
    rows: [
      { meal: "Chicken Pasta Salad", date: "21/09/26", totalKey: "sept-plan3-chicken-pasta-salad" },
      { meal: "Pepperoni Roll Ups", date: "22/09/26", totalKey: "sept-plan3-pepperoni-roll-ups" },
      { meal: "BBQ Chicken Drumstick", date: "23/09/26", totalKey: "sept-plan3-bbq-chicken-drumstick" },
      { meal: "Lasagne", date: "24/09/26", totalKey: "sept-plan3-lasagne" },
      { meal: "Breaded Fish with Potato Waffles", date: "25/09/26", totalKey: "sept-plan3-fish-waffles" },
    ],
  },
  {
