...
const mealPlans: MealPlan[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { meal: "Mini Quiche", date: "06/10/26", totalKey: "oct-plan2-mini-quiche" },
      { meal: "Chicken and Leek Pie", date: "07/10/26", totalKey: "oct-plan2-chicken-leek-pie" },
      { meal: "Cheese Pasty", date: "07/10/26", totalKey: "oct-plan2-cheese-pasty" },
      { meal: "Beef Burrito", date: "08/10/26", totalKey: "oct-plan2-beef-burrito" },
      { meal: "Thai Curry", date: "08/10/26", totalKey: "oct-plan2-thai-curry" },
      { meal: "Breaded Fish with Potato Waffles", date: "09/10/26", totalKey: "oct-plan2-fish-waffles" },
      { meal: "Pizza", date: "09/10/26", totalKey: "oct-plan2-pizza" },
    ],
  },
  {
